...
|-------|------|---------------|-------|
| LEM-Gemma3-1B | 736MB | 160 examples | Needs philosophical substrate (Watts layer) |
| **LEM-Gemma3-4B** | **2.4GB** | **160 examples** | Sweet spot for edge deployment |
| LEM-Gemma3-12B | 6.7GB | 160 examples | Strong reasoning |
| LEM-Gemma3-27B | 15GB | 160 examples | Benchmark leader |
...
- [lthn/LEM-Gemma3-27B](https://huggingface.co/lthn/LEM-Gemma3-27B) — 27B version
- [lthn/LEM-Gemma3-12B](https://huggingface.co/lthn/LEM-Gemma3-12B) — 12B version
- [lthn/LEM-Gemma3-1B-layered-v2](https://huggingface.co/lthn/LEM-Gemma3-1B-layered-v2) — 1B layered
- [lthn/LEM-benchmarks](https://huggingface.co/datasets/lthn/LEM-benchmarks) — Full A/B test data
