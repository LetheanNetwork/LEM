...
- [lthn/LEM-Gemma3-1B-layered-v2](https://huggingface.co/lthn/LEM-Gemma3-1B-layered-v2) — 1B layered version
- [lthn/LEM-GPT-OSS-20B](https://huggingface.co/lthn/LEM-GPT-OSS-20B) — GPT-OSS version
